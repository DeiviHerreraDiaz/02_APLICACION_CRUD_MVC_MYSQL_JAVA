...
<body>
  <h1 style="text-align: center;">REGISTRAR USUARIO DAVIPLATA</h1>
  ...
  <main>
    <form action="usuario" class="formulario" method="POST">
      ...
      <h3>CREAR CUENTA</h1>
        ...
        <div>
            <input type="text " class="input" placeholder="Cédula" name="cedula">
            <label>Cédula</label>
        </div>
        ...
        <button class="botondaviplata" name="accion" value="registrarUsuDav" type="submit">INSERTAR</button>
