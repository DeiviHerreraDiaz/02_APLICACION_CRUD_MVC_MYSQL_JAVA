...
<head>
    ...
    <title>CONSULTAR USUARIOS DAVIPLATA</title>
...
<body>
  ...
  <header class="daviplata_inter">
    <p>CONSULTAR USUARIOS DAVIPLATA</p>
  </header>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light p-3" id="menu">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="usuario?vista=interD">ATRAS <span class="sr-only">(current)</span></a>
          </li>
        ...
        <table class="table">
            ...
            <tbody> 
                ...
                <tr>
                        <td><input type="number"  name="idUsuario" value="${usuario.getIdUsuario()}" hidden>${usuario.getIdUsuario()}</td>
                        <td><input type="text" name="nombreUsuario" value="${usuario.getNombreUsuario()}"></td>
                        <td><input type="text" name="apellido" value="${usuario.getApellidoUsuario()}"></td>
                        <td><input type="text" name="cedula" value="${usuario.getCedula()}"></td>
