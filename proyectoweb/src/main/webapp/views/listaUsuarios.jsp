  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
      ...
      <table class="table">
        ...
        <tbody>
          <c:forEach var="usuario" items="${usuarioVO}">
            <form action="usuario" method="POST">
              <tr>
                    ...
                    <td><input type="text" name="correoUsuario" value="${usuario.getCorreoUsuario()}"></td>
                    ...
                    <td><input type="text" name="estado" value="${usuario.isEstado()}"></td>  
                    <td>
      ...
      <footer class="footernequi">
        <p>Usuarios. &copy; Todos Los Derechos Reservados 2023 </p>
        <div id="iconos">
