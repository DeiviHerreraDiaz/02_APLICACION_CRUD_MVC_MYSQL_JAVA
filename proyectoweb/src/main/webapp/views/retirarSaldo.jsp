...
<body>
    ...
    <form class="formulario" action="bolsillo" method="POST">
      ...
      <h3>Retirar</h1>
        ...
        <div>
          ...
          <input type="number" class="input" placeholder="saldo" name="valorRetiro">
          <label>¿Cuanto desea retirar?</label>
        </div>


        <button class="botonnequi" type="submit" name="accion" value="retirar">Retirar</button>
  ...
  <footer class="footernequi">
    ...
    <p>Bolsillo. &copy; Todos Los Derechos Reservados 2023 </p>
    <div id="iconos">
