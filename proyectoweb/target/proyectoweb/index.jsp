      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="usuario?vista=registrarUsuario">Registrar usuarios</a>
            <a class="dropdown-item" href="usuario?vista=listar">Consultar usuarios</a>
            <a class="dropdown-item" href="index?vista=login">LOGIN</a>
