          ...
          <c:forEach var="bolsillo" items="${bolsillo}">
            <form action="bolsillo" method="POST">
              <tr>
                    ...
                    <td>${bolsillo.isEstado()}</td>
            
                 <td>
                  <input type="hidden" name="idBolsillo" value="${bolsillo.getIdBolsillo()}">
                  <button type="submit" name="accion" value="consultar">CONSULTAR</button>
                </td>
                
                <td>
                  
                  <a href="bolsillo?vista=recargar&idBolsillo=<c:out value='${bolsillo.idBolsillo}'/>">RECARGAR</a>
              </td>
                <td>
                  <a href="bolsillo?vista=retirar&idBolsillo=<c:out value='${bolsillo.idBolsillo}'/>">RETIRAR</a>
                </td>  
